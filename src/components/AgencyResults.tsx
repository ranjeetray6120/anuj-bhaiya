      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start lg:items-center">
        ...
        <div className="lg:col-span-7 flex flex-col gap-4 select-none">
          ...
          <div className="flex items-center gap-3 self-start pl-1">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#168ed3] text-white flex flex-col items-center justify-center text-center shadow-lg ring-3 ring-blue-100 flex-shrink-0">
              <span className="text-xs sm:text-sm font-black leading-none">764K</span>
          ...
          {/* Campaign Table */}
          <div className="w-full bg-white rounded-2xl border border-slate-200 shadow-xl p-4 sm:p-5 relative z-10">
